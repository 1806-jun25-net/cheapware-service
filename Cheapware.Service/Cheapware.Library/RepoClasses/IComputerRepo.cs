...
namespace Cheapware.Library.RepoClasses
{
    public interface IComputerRepo
    {
        ...
        Task<int> GetRecentOrderByCustomerId(int id);
        //Junction Method
        void AddJunction(int id, List<Inventory> names);
        ...
        Task DeleteByCartId(int cartId);
        Task<List<Cart>> CartIdsByCustomer(int id);
